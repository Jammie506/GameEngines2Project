            ...
            switch (simulation.Type)
            {
                ...
                case SimulationType.HavokPhysics:
                {
                    ...
                    var parameters = new JobsUtility.JobScheduleParameters(
                        ...
                        UnsafeUtility.AddressOf(ref data), CollisionEventJobProcess<T>.Initialize(), inputDeps, ScheduleMode.Single);
#else
                        UnsafeUtility.AddressOf(ref data), CollisionEventJobProcess<T>.Initialize(), inputDeps, ScheduleMode.Batched);
#endif
