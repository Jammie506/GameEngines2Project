...
namespace Unity.Build.Classic.Private.MissingPipelines
{
    ...
    /// </summary>
    class MissingNonIncrementalPipeline : ClassicNonIncrementalPipelineBase
    {
        private Platform m_MissingPlatform;

        public override Platform Platform => m_MissingPlatform;

        public MissingNonIncrementalPipeline(Platform missingPlatform)
        {
            m_MissingPlatform = missingPlatform;
        }
