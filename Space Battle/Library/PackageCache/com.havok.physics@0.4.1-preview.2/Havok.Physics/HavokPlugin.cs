...
namespace Havok.Physics
{
    public static class Plugin
    {
        ...
        internal static extern unsafe void HP_SyncWorldIn(
            int worldIndex,
            int numSecondaryBodies, int numDynamicBodies, int numStaticBodies,
            void* rigidBodies, int rigidBodyStride,
            MotionData* motionDatas, int motionDataStride,
            MotionVelocity* motionVelocities, int motionVelocityStride,
        ...
        internal static extern unsafe void HP_SyncMotionsOut(
            int worldIndex,
            MotionData* dynamicMotionDatas, int numDynamicMotionDatas, int dynamicMotionDataStride,
            MotionVelocity* dynamicMotionVelocities, int numDynamicMotionVelocities, int dynamicMotionVelocityStride,
            int startIndex, int num);
        [DllImport(k_DllPath)]
        internal static extern unsafe void HP_SyncSecondaryMotionsOut(
            int worldIndex,
            MotionData* secondaryMotionDatas, int numSecondaryMotionDatas, int secondaryMotionDataStride,
            MotionVelocity* secondaryMotionVelocities, int numSecondaryMotionVelocities, int secondaryMotionVelocityStride,
            int startIndex, int num);
        [DllImport(k_DllPath)]
